    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="gold-line w-16 sm:w-20 h-0.5 bg-gold mx-auto mb-4 sm:mb-6" />
        ...
        <div className="grid lg:grid-cols-5 gap-6 md:gap-8 lg:gap-10">
          ...
          >
            ...
            {/* بطاقة ساعات العمل للشاشات الكبيرة */}
            <div className="hidden lg:block bg-cream dark:bg-navy p-6 sm:p-8 rounded-2xl border border-gray-100 dark:border-gray-800">
              <h3 className="text-lg sm:text-xl font-bold text-navy dark:text-white mb-4">ساعات العمل</h3>
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                <p>🕐 السبت - الخميس: 9 صباحاً - 6 مساءً</p>
                <p>📅 الجمعة: عطلة</p>
                <p className="text-xs mt-3">نرد على استفساراتكم خلال 24 ساعة</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="lg:hidden fixed bottom-4 left-4 right-4 bg-white dark:bg-navy rounded-full shadow-lg p-2 z-50 md:hidden">
          <div className="flex justify-around items-center">
            <a href="#home" className="flex flex-col items-center p-2 text-gold">
